      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          {pillars.map((pillar, index) => (
            ...
            >
              <div className="bg-white rounded-2xl p-8 border border-gray-200 h-full hover:border-indigo-300 hover:shadow-xl transition-all duration-300">
                {/* Step number */}
                <div className="absolute -top-4 -left-4 w-8 h-8 bg-gradient-to-br from-indigo-600 to-purple-600 rounded-full flex items-center justify-center text-white font-bold text-sm shadow-lg">
                  {index + 1}
                </div>
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          transition={{ duration: 0.6 }}
          className="bg-gradient-to-r from-indigo-50 to-purple-50 rounded-2xl p-8 flex flex-col md:flex-row items-center gap-6"
        >
          <div className="w-16 h-16 bg-white rounded-xl shadow-md flex items-center justify-center flex-shrink-0">
            <BarChart3 className="w-8 h-8 text-indigo-600" />
          </div>
          <div className="text-center md:text-left">
            <h3 className="text-xl font-bold text-gray-900 mb-2">+ Analytics Feed</h3>
        ...
        >
          ...
          <div className="bg-gray-50 rounded-2xl p-8 border border-gray-100">
            <h4 className="text-lg font-semibold text-gray-900 mb-4">Branded QR Codes</h4>
            <img
