      ...
      <section className="py-4 lg:py-6 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            {/* Agreement Section */}
            <div className="mb-12">
              <h2 className="text-3xl font-bold text-slate-900 mb-6">Agreement to Our Legal Terms</h2>
              ...
              <p className="text-gray-600 mb-4">
                We operate the website <a href="https://brandcodes.io" target="_blank" rel="noopener noreferrer" className="text-indigo-600 hover:text-indigo-800">https://brandcodes.io</a> (the '<strong>Site</strong>'), as well as any other related products and services that refer or link to these legal terms (the '<strong>Legal Terms</strong>') (collectively, the '<strong>Services</strong>').
              </p>
              <p className="text-gray-600 mb-4">
              ...
              <p className="text-gray-600 mb-4">
                You can contact us by phone at 90353055, email at <a href="mailto:info@brandcodes.io" className="text-indigo-600 hover:text-indigo-800">info@brandcodes.io</a>, or by mail to 13 Computing Dr, Singapore 117417, Singapore.
              </p>
              <p className="text-gray-600 mb-4">
              ...
              <p className="text-gray-600 mb-4">
                We will provide you with prior notice of any scheduled changes to the Services you are using. The modified Legal Terms will become effective upon posting or notifying you by <a href="mailto:info@brandcodes.io" className="text-indigo-600 hover:text-indigo-800">info@brandcodes.io</a>, as stated in the email message. By continuing to use the Services after the effective date of any changes, you agree to be bound by the modified terms.
              </p>
            ...
            <div className="bg-indigo-50 rounded-xl p-8 mb-12">
              ...
              <ol className="list-decimal pl-6 text-indigo-600 space-y-2">
                <li><a href="#services" className="hover:text-indigo-800">OUR SERVICES</a></li>
                <li><a href="#ip" className="hover:text-indigo-800">INTELLECTUAL PROPERTY RIGHTS</a></li>
                <li><a href="#userreps" className="hover:text-indigo-800">USER REPRESENTATIONS</a></li>
                <li><a href="#userreg" className="hover:text-indigo-800">USER REGISTRATION</a></li>
                <li><a href="#purchases" className="hover:text-indigo-800">PURCHASES AND PAYMENT</a></li>
                <li><a href="#subscriptions" className="hover:text-indigo-800">SUBSCRIPTIONS</a></li>
                <li><a href="#prohibited" className="hover:text-indigo-800">PROHIBITED ACTIVITIES</a></li>
                <li><a href="#ugc" className="hover:text-indigo-800">USER GENERATED CONTRIBUTIONS</a></li>
                <li><a href="#license" className="hover:text-indigo-800">CONTRIBUTION LICENCE</a></li>
                <li><a href="#socialmedia" className="hover:text-indigo-800">SOCIAL MEDIA</a></li>
                <li><a href="#thirdparty" className="hover:text-indigo-800">THIRD-PARTY WEBSITES AND CONTENT</a></li>
                <li><a href="#sitemanage" className="hover:text-indigo-800">SERVICES MANAGEMENT</a></li>
                <li><a href="#ppyes" className="hover:text-indigo-800">PRIVACY POLICY</a></li>
                <li><a href="#copyrightyes" className="hover:text-indigo-800">COPYRIGHT INFRINGEMENTS</a></li>
                <li><a href="#terms" className="hover:text-indigo-800">TERM AND TERMINATION</a></li>
                <li><a href="#modifications" className="hover:text-indigo-800">MODIFICATIONS AND INTERRUPTIONS</a></li>
                <li><a href="#law" className="hover:text-indigo-800">GOVERNING LAW</a></li>
                <li><a href="#disputes" className="hover:text-indigo-800">DISPUTE RESOLUTION</a></li>
                <li><a href="#corrections" className="hover:text-indigo-800">CORRECTIONS</a></li>
                <li><a href="#disclaimer" className="hover:text-indigo-800">DISCLAIMER</a></li>
                <li><a href="#liability" className="hover:text-indigo-800">LIMITATIONS OF LIABILITY</a></li>
                <li><a href="#indemnification" className="hover:text-indigo-800">INDEMNIFICATION</a></li>
                <li><a href="#userdata" className="hover:text-indigo-800">USER DATA</a></li>
                <li><a href="#electronic" className="hover:text-indigo-800">ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES</a></li>
                <li><a href="#california" className="hover:text-indigo-800">CALIFORNIA USERS AND RESIDENTS</a></li>
                <li><a href="#misc" className="hover:text-indigo-800">MISCELLANEOUS</a></li>
            ...
            <div id="services" className="mb-12">
              <h2 className="text-3xl font-bold text-slate-900 mb-6">1. Our Services</h2>
              <p className="text-gray-600 mb-4">
            ...
            <div id="ip" className="mb-12">
              <h2 className="text-3xl font-bold text-slate-900 mb-6">2. Intellectual Property Rights</h2>
              <h3 className="text-2xl font-semibold text-slate-800 mb-4">Our intellectual property</h3>
              <p className="text-gray-600 mb-4">
              ...
              <h3 className="text-2xl font-semibold text-slate-800 mb-4">Your use of our Services</h3>
              <p className="text-gray-600 mb-4">
            ...
            <div id="userreps" className="mb-12">
              <h2 className="text-3xl font-bold text-slate-900 mb-6">3. User Representations</h2>
              <p className="text-gray-600 mb-4">
            ...
            <div id="userreg" className="mb-12">
              <h2 className="text-3xl font-bold text-slate-900 mb-6">4. User Registration</h2>
              <p className="text-gray-600">
            ...
            <div id="purchases" className="mb-12">
              <h2 className="text-3xl font-bold text-slate-900 mb-6">5. Purchases and Payment</h2>
              <p className="text-gray-600 mb-4">
            ...
            <div id="subscriptions" className="mb-12">
              <h2 className="text-3xl font-bold text-slate-900 mb-6">6. Subscriptions</h2>
              <h3 className="text-2xl font-semibold text-slate-800 mb-4">Billing and Renewal</h3>
              <p className="text-gray-600 mb-4">
              ...
              <h3 className="text-2xl font-semibold text-slate-800 mb-4">Cancellation</h3>
              <p className="text-gray-600 mb-4">
              ...
              <h3 className="text-2xl font-semibold text-slate-800 mb-4">Fee Changes</h3>
              <p className="text-gray-600">
            ...
            <div id="prohibited" className="mb-12">
              <h2 className="text-3xl font-bold text-slate-900 mb-6">7. Prohibited Activities</h2>
              <p className="text-gray-600 mb-4">
                You may not access or use the Services for any purpose other than that for which we make the Services available. The Services may not be used in connection with any commercial endeavors except those that are specifically endorsed or approved by us.
              </p>
              <p className="text-gray-600 mb-4">As a user of the Services, you agree not to:</p>
            ...
            <div id="ugc" className="mb-12">
              <h2 className="text-3xl font-bold text-slate-900 mb-6">8. User Generated Contributions</h2>
              <p className="text-gray-600 mb-4">
            ...
            <div id="license" className="mb-12">
              <h2 className="text-3xl font-bold text-slate-900 mb-6">9. Contribution Licence</h2>
              <p className="text-gray-600 mb-4">
            ...
            <div id="socialmedia" className="mb-12">
              <h2 className="text-3xl font-bold text-slate-900 mb-6">10. Social Media</h2>
              <p className="text-gray-600">
            ...
            <div id="thirdparty" className="mb-12">
              <h2 className="text-3xl font-bold text-slate-900 mb-6">11. Third-Party Websites and Content</h2>
              <p className="text-gray-600 mb-4">
            ...
            <div id="sitemanage" className="mb-12">
              <h2 className="text-3xl font-bold text-slate-900 mb-6">12. Services Management</h2>
              <p className="text-gray-600">
            ...
            <div id="ppyes" className="mb-12">
              <h2 className="text-3xl font-bold text-slate-900 mb-6">13. Privacy Policy</h2>
              <p className="text-gray-600 mb-4">
                We care about data privacy and security. Please review our Privacy Policy: <Link to="/privacy" className="text-indigo-600 hover:text-indigo-800">Privacy Policy</Link>. By using the Services, you agree to be bound by our Privacy Policy, which is incorporated into these Legal Terms.
              </p>
              <p className="text-gray-600">
            ...
            <div id="copyrightyes" className="mb-12">
              <h2 className="text-3xl font-bold text-slate-900 mb-6">14. Copyright Infringements</h2>
              <p className="text-gray-600">
            ...
            <div id="terms" className="mb-12">
              <h2 className="text-3xl font-bold text-slate-900 mb-6">15. Term and Termination</h2>
              <p className="text-gray-600 mb-4">
            ...
            <div id="modifications" className="mb-12">
              <h2 className="text-3xl font-bold text-slate-900 mb-6">16. Modifications and Interruptions</h2>
              <p className="text-gray-600 mb-4">
            ...
            <div id="law" className="mb-12">
              <h2 className="text-3xl font-bold text-slate-900 mb-6">17. Governing Law</h2>
              <p className="text-gray-600">
            ...
            <div id="disputes" className="mb-12">
              <h2 className="text-3xl font-bold text-slate-900 mb-6">18. Dispute Resolution</h2>
              <h3 className="text-2xl font-semibold text-slate-800 mb-4">Informal Negotiations</h3>
              <p className="text-gray-600 mb-4">
            ...
            <div id="corrections" className="mb-12">
              <h2 className="text-3xl font-bold text-slate-900 mb-6">19. Corrections</h2>
              <p className="text-gray-600">
            ...
            <div id="disclaimer" className="mb-12">
              <h2 className="text-3xl font-bold text-slate-900 mb-6">20. Disclaimer</h2>
              <p className="text-gray-600">
            ...
            <div id="liability" className="mb-12">
              <h2 className="text-3xl font-bold text-slate-900 mb-6">21. Limitations of Liability</h2>
              <p className="text-gray-600">
            ...
            <div id="indemnification" className="mb-12">
              <h2 className="text-3xl font-bold text-slate-900 mb-6">22. Indemnification</h2>
              <p className="text-gray-600">
            ...
            <div id="userdata" className="mb-12">
              <h2 className="text-3xl font-bold text-slate-900 mb-6">23. User Data</h2>
              <p className="text-gray-600">
            ...
            <div id="electronic" className="mb-12">
              <h2 className="text-3xl font-bold text-slate-900 mb-6">24. Electronic Communications, Transactions, and Signatures</h2>
              <p className="text-gray-600">
            ...
            <div id="california" className="mb-12">
              <h2 className="text-3xl font-bold text-slate-900 mb-6">25. California Users and Residents</h2>
              <p className="text-gray-600">
            ...
            <div id="misc" className="mb-12">
              <h2 className="text-3xl font-bold text-slate-900 mb-6">26. Miscellaneous</h2>
              <p className="text-gray-600 mb-4">
            ...
            <div id="contact" className="mb-12">
              <h2 className="text-3xl font-bold text-slate-900 mb-6">27. Contact Us</h2>
              <p className="text-gray-600 mb-4">
                In order to resolve a complaint regarding the Services or to receive further information regarding use of the Services, please contact us at:
              </p>
              <div className="bg-gray-50 rounded-lg p-6">
                <p className="text-gray-700 font-semibold">Brandcodes</p>
                <p className="text-gray-600">13 Computing Dr</p>
                <p className="text-gray-600">Singapore 117417</p>
                <p className="text-gray-600">Singapore</p>
                <p className="text-gray-600 mt-2">Phone: 90353055</p>
                <p className="text-gray-600">
                  Email: <a href="mailto:info@brandcodes.io" className="text-indigo-600 hover:text-indigo-800">info@brandcodes.io</a>
                </p>
              </div>
            </div>
          </motion.div>
